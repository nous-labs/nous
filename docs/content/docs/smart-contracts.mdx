...
Each helper simply fills in the `contractIndex` for you. When an "easy contract" wrapper exists (see the [Easy Contracts](/easy-contracts)
...
<Callout type="info" title="Building & deploying contracts">
  Clone <a href="https://github.com/hackerby888/qubic-core-lite">qubic-core-lite</a> alongside your project to compile or
  simulate smart contracts, then broadcast the resulting transactions with the SDK. The
  <a href="/docs/getting-started/nextjs-scaffold">Next.js scaffold</a> demonstrates the full workflow.
</Callout>
...
[`Wallet Integration` guide](/guides/wallet-integration) for full end-to-end examples.

<Callout type="info" title="Need the full mental model?">
  The new <a href="/guides/smart-contract-lifecycle">Smart Contract Lifecycle</a> guide explains how functions,
