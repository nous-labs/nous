...
All helpers are exported through the `@nouslabs/sdk/utils` entrypoint:

```typescript
import { qx, qutil, quottery, qearn, qswap, qvault, ccf } from '@nouslabs/sdk/utils';
...
```typescript
import { query, QUBIC_CONTRACTS } from '@nouslabs/sdk/utils';
...
import { qx, qswap, qearn, qutil, qvault } from '@nouslabs/sdk/utils';
...
- Identities are expected to be uppercase base32 strings; use the validation helpers in `@nouslabs/sdk/utils`.
