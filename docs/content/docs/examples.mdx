...
<Callout type="info" title="Scaffold a full app">
  Follow the <a href="/docs/getting-started/nextjs-scaffold">Next.js scaffold</a> to combine the SDK, React hooks, and
  <code>qubic-core-lite</code> for contract development.
</Callout>
...
```typescript
import { QubicLiveClient, stringToUint64 } from '@nouslabs/sdk';
import { qx } from '@nouslabs/sdk/utils';
...
```typescript
import { QubicLiveClient } from '@nouslabs/sdk';
import { qutil } from '@nouslabs/sdk/utils';
...
```typescript
import { QubicLiveClient } from '@nouslabs/sdk';
import { WalletConnectAdapter } from '@nouslabs/sdk';
...
```typescript
import { QubicLiveClient, hexToBase64 } from '@nouslabs/sdk';
import { WalletAdapter } from '@nouslabs/sdk';
