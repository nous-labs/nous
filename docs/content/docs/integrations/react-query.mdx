...
<Tabs items={['npm', 'yarn', 'bun', 'pnpm']}>
  ...
  <Tab value="yarn">
    ```bash
    yarn add @nvlabs/qts @tanstack/react-query react
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add @nvlabs/qts @tanstack/react-query react
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    pnpm add @nvlabs/qts @tanstack/react-query react
    ```
  </Tab>
</Tabs>
...
```tsx
import { useBroadcastTransaction } from '@nvlabs/qts/react/query';
...
```tsx
import { useTickPoller, useBalancePoller } from '@nvlabs/qts/react/query';
...
```tsx
import { useBroadcastTransaction, qubicQueryKeys } from '@nvlabs/qts/react/query';
import { useQueryClient } from '@tanstack/react-query';
