...
<Callout type="success">
  **Hall of Fame** - Coming Soon!
  ...
  Be the first to support the project and see your contribution recognized here. All donations of 100M QUBIC (~$100) or more will be listed with the donor's identity (if you wish to be recognized).
  
  Major supporters (1B+ QUBIC / ~$1,000+) receive special recognition, direct access to maintainers, and priority feature requests.
</Callout>
...
*To be listed on this page, please send a message on [GitHub Discussions](https://github.com/nvlabs/qts/discussions) or [Discord](https://discord.gg/qubic) with your donation transaction ID and how you'd like to be recognized (Qubic identity, alias, or anonymous).*
...
<Callout type="info">
  Questions about donations? Reach out on [GitHub Discussions](https://github.com/nvlabs/qts/discussions) or [Discord](https://discord.gg/qubic).
</Callout>
