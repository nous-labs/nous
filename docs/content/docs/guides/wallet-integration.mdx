...
The module lives in `@nouslabs/sdk/wallet` and is tree-shakeable.
...
```tsx
import { QubicProvider, useQubic, WalletConnectProvider, useWalletConnect } from '@nouslabs/sdk/react';
